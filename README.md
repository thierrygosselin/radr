...
[![Last-changedate](https://img.shields.io/badge/last%20change-2026--08--20-brightgreen.svg)](/commits/main)
<!-- badges: end -->
...
Some VCF-level filters use `bcftools`, while `run_bayescan()` uses the
BayeScan executable. These are programs, not R packages. A shared Conda
environment can provide both:
...
> <https://github.com/thierrygosselin/radr>. Accessed 2026-08-20.
