...
highly curated human datasets for which many genomic tools were designed.**
It is built for the realities of population genomics in model and non-model
organisms, including:
...
\(F_{\mathrm{ST}}\), small technical biases can be comparable in magnitude to
the biological signal under investigation. Missingness therefore cannot safely
be treated only as a computational inconvenience: it may itself be a biological
or experimental covariate.

Accordingly, radr emphasizes transparent diagnostics, recalculation after
samples or markers are removed, strata-aware summaries, and explicit warnings
when technical structure may affect biological interpretation. It does not
assume that upstream genotyping produced a uniformly complete or perfectly
balanced dataset.
