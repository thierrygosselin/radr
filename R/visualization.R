...
#' @param tidy.vcf.file The tidy VCF file created with tidy_genome.
...
#' @seealso \link[genometranslator]{tidy_genome}
...
#' @title radr helper plot used in MAC, MAF and MAD filter
#' @description GGPLOT2 radr helper plot used in MAC, MAF and MAD filter.
...
#' @rdname plot_boxplot_diversity
#' @keywords internal
radr_helper_plot <- function(data, strata = FALSE, stats, x.axis.title = NULL, x.breaks = NULL, text.orientation = "horizontal", plot.filename = NULL) {
