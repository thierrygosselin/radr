...
#' Both radr and stackr functions requires \code{stringdist} package.
#'
...
pi <- function(
  ...
  tgbase::check_package(package = "stringdist")
  # Cleanup-------------------------------------------------------------------
  tgbase::function_header(f.name = "pi", verbose = verbose)
  ...
  on.exit(tgbase::function_header(f.name = "pi", start = FALSE, verbose = verbose), add = TRUE)
  res <- list()
