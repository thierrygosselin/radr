    ...
    if (verbose) {
      ...
      if (any(check.strata %in% names(dots.deprecated))) {
        message("\nNote: manipulating strata related arguments\n",
                "is best done inside genometranslator::read_strata\n")
      }
    }
  }
...
# dots_keepers_core ------------------------------------------------------------
# R/radr_dots_defaults.R
# Core global keepers/deprecated used across radr functions


#' @title Global dot-argument "keepers" for radr
#' @description
#' Internal helper returning the core set of supported `...` arguments
#' used across most radr functions.
#' @keywords internal
#' @export
...
#' @title Global deprecated dot-arguments for radr
#' @description
