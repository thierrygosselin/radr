...
#' 50 percent missing genotypes. Must be between 0 and 1.
#'
...
#'   radr statistics and plotting machinery.
#' }
#'
#' @return
...
filter_genotyping_vcf <- function(
  ...
  genometranslator::bcftools_require(bcftools.path = bcftools.path)
  ...
  genometranslator::bcftools_exec(
  ...
  if (compress && index) {
    ...
    res.idx <- genometranslator::bcftools_exec(
      bcftools.path  = bcftools.path,
